...
export const DOCS_REGISTRY: DocEntry[] = [
  ...
  },
  {
    ...
    title: 'Atendimentos / Suporte Técnico',
    category: 'modules',
    module: 'atendimentos',
    summary: 'Centro de operações (NOC) — chamados técnicos, suporte N1/N2/N3, SLA, filas, plantão e Customer Success.',
    file: 'modules/atendimentos',
    tags: ['atendimentos', 'suporte', 'chamados', 'sla', 'noc', 'tickets', 'n1', 'n2', 'n3', 'cs', 'plantão'],
    downloadable: true,
    visibleInMenu: true,
    order: 12,
  },
  {
    ...
    title: 'Arquitetura do Suporte',
    category: 'core',
    module: 'atendimentos',
    summary: 'Arquitetura completa do módulo de suporte técnico: componentes, fluxos, segurança e integração.',
    file: '_existing/OPEN_SUPPORT_ARCHITECTURE',
    tags: ['suporte', 'arquitetura', 'edge functions', 'supabase', 'tickets'],
    downloadable: true,
    visibleInMenu: true,
    order: 11,
  },
  {
    slug: 'support/data-model',
    title: 'Modelo de Dados do Suporte',
    category: 'core',
    module: 'atendimentos',
    summary: 'Modelo completo de dados do suporte técnico: tabelas, enums, relacionamentos e RLS.',
    file: '_existing/OPEN_SUPPORT_DATA_MODEL',
    tags: ['suporte', 'data-model', 'schema', 'tabelas', 'enums'],
    downloadable: true,
    visibleInMenu: true,
    order: 12,
  },
  {
    slug: 'support/rbac',
    title: 'RBAC do Suporte',
    category: 'core',
    module: 'atendimentos',
    summary: 'Controle de acesso do módulo de suporte: níveis, permissões, visibilidade e regras de segurança.',
    file: '_existing/OPEN_SUPPORT_RBAC',
    tags: ['suporte', 'rbac', 'segurança', 'permissões', 'acesso'],
    downloadable: true,
    visibleInMenu: true,
    order: 13,
  },
  {
    slug: 'support/api-reference',
    title: 'API do Suporte Técnico',
    category: 'api',
    module: 'atendimentos',
    summary: 'Referência completa das Edge Functions do módulo de suporte: endpoints, payloads e respostas.',
    file: '_existing/OPEN_SUPPORT_API_REFERENCE',
    tags: ['suporte', 'api', 'edge functions', 'endpoints', 'tickets'],
    downloadable: true,
    visibleInMenu: true,
    order: 21,
  },
  {
    ...
    title: 'Runbook do Suporte',
    category: 'runbooks',
    module: 'atendimentos',
    summary: 'Procedimentos operacionais N1/N2/N3, incidentes críticos, SLA, filas e plantão.',
    file: '_existing/OPEN_SUPPORT_RUNBOOK',
    tags: ['suporte', 'runbook', 'operação', 'n1', 'n2', 'n3', 'sla', 'incidente'],
    downloadable: true,
    visibleInMenu: true,
    order: 37,
  },
  {
    slug: 'support/kpis',
    title: 'KPIs do Suporte',
    category: 'modules',
    module: 'atendimentos',
    summary: 'Indicadores de performance do suporte: SLA, tempos médios, volume, distribuição e metas.',
    file: '_existing/OPEN_SUPPORT_KPIS',
    tags: ['suporte', 'kpis', 'métricas', 'sla', 'performance'],
    downloadable: true,
    visibleInMenu: true,
    order: 14,
  },
