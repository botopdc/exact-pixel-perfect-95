...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // ── Serve existing PDF — always fresh from DB, no cache ────────
    const proposalPdfPath = proposal.pdf_path || null;

    console.log("[proposal-public] proposal_id=", proposal.id);
    console.log("[proposal-public] db_pdf_path=", proposalPdfPath);
    console.log("[proposal-public] source=", "public");
    console.log("[proposal-public] generator=", "calculator_renderer");
    console.log("[proposal-public] reused_existing_pdf=", !!proposalPdfPath);

    // Generate a FRESH signed PDF URL from the current db pdf_path — no caching
    ...
    if (proposalPdfPath) {
      ...
      console.log("[proposal-public] pdf_path missing — client will generate using calculator renderer");
    }

    console.log("[proposal-public] returned_pdf_path=", proposalPdfPath);
    console.log("[proposal-public] signed_url_generated_from=", proposalPdfPath);
